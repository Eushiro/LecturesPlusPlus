...
function createCommentView(video) {
    ...
    `<div style="margin-left:22px; margin-top:16px;">
        <input id="questionBox" type="text" style="width: 230px; height: 25px" placeholder="Ask a question">
    ...
    shadowOfController.querySelector("#submitButton").addEventListener('click', function () { submitButtonOnClick(); 
        shadowOfController.querySelector('#questionBox').value = ""}, false)
